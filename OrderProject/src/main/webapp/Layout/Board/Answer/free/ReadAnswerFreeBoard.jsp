				...
				<form id="WriteBoardFrm" name="WriteBoardFrm" class="WriteBoardFrm">
					...
					<table class="table freeboard_tbl">
						<tbody class="tbody">
							...
							<tr>
								<td>
									<!-- 답변 게시글에 적용시킬 값  --> <input type="hidden" name="boardParam"
									id="boardAnswerParam" value="${param.boardParam}">
								</td>
							</tr>
						</tbody>
						<tfoot class="tfoot">
							<tr>
								...
								<td colspan="3" class="tfoot_btn_td">
									<ul class="btn_ul">
										<li><button id="AnswerboardReviseBtn">수정</button></li>
										<li><button id="AnswerboardDeleteBtn">삭제</button></li>
										<li><button id="AnswerboardAnswerBtn">답변</button></li>
									</ul>
								</td>
							</tr>
						</tfoot>
