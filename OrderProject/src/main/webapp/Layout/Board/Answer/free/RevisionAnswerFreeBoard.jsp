		...
		<div class="main_board_wrapper">
			...
			<div class="table_wrapper">
				...
				<form id="WriteBoardFrm" name="WriteBoardFrm" class="WriteBoardFrm">
					<input type="hidden" id="boardCnt" value="9"/>
					<table class="table Writefreeboard_tbl">
						<tbody class="tbody">
							<tr>
								<th class="th_writer">작성자</th>
								<td><input type="text" value="${param.revWriter}" name="boardWriter" id="revWriter">
								</td>
							</tr>
							<tr>
								<th class="th">E-mail</th>
								<td><input type="email" class="email" id="email" name="boardEmail" value=" "></td>
							</tr>
							<tr>
								<th class="th">제목</th>
