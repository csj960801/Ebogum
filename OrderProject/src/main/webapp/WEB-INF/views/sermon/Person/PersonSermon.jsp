			...
			<div class="table_wrapper table-responsive">
			 ...
			 <form id="sermonFrm" name="sermonFrm">
				...
				<table class="table freeboard_tbl">
					...
					<tbody class="tbody">
						<c:if test="${!empty PersonSermonlist}">
							<c:forEach varStatus="status" items="${PersonSermonlist}" var="sermonlist">
								<tr>
						...
						<c:choose>
							<c:when test="${empty PersonSermonlist}">
								<tr>
