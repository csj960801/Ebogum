	...
	<div class="main_col col-md-9 col-xs-9">
		<div class="main_board_wrapper">
			...
			<div class="sermonTitle_wrapper">
				<h3 class="sermonTitle">사건별 설교</h3>
			</div>

			<div class="table_wrapper table-responsive">
			
			 <form id="sermonFrm" name="sermonFrm">
				<input type="hidden" id="SermonKind" value="sagunbyol" />
				...
				<table class="table freeboard_tbl">
					...
					<tbody class="tbody">
						<c:if test="${!empty SagunbyolSermonlist}">
							<c:forEach varStatus="status" items="${SagunbyolSermonlist}" var="sermonlist">
								<tr>
						...
						<c:choose>
							<c:when test="${empty SagunbyolSermonlist}">
								<tr>
