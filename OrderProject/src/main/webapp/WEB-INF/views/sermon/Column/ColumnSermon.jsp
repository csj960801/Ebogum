		...
		<div class="main_board_wrapper">
			...
			<div class="table_wrapper table-responsive">
			 ...
			 <form id="sermonFrm" name="sermonFrm">
				...
				<input type="hidden" id="SermonKind" value="column" />
				...
				<table class="table freeboard_tbl">
					...
					<tbody class="tbody">
						<c:if test="${!empty ColumnSermonlist}">
							<c:forEach varStatus="status" items="${ColumnSermonlist}" var="sermonlist">
								<tr>
						...
						<c:choose>
							<c:when test="${empty ColumnSermonlist}">
								<tr>
