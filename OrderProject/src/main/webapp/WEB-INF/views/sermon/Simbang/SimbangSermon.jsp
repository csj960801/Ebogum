		...
		<div class="main_board_wrapper">
			...
			<div class="table_wrapper table-responsive">
			 ...
			 <form id="sermonFrm" name="sermonFrm">
				...
				<input type="hidden" id="SermonKind" value="simbang" />
				...
				<table class="table freeboard_tbl">
					...
					<tbody class="tbody">
						<c:if test="${!empty SimbangSermonlist}">
							<c:forEach varStatus="status" items="${SimbangSermonlist}" var="sermonlist">
								<tr>
						...
						<c:choose>
							<c:when test="${empty SimbangSermonlist}">
								<tr>
