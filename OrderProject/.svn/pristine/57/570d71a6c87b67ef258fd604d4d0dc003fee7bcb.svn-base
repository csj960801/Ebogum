		...
		<div class="main_board_wrapper">
			...
			<div class="table_wrapper table-responsive">
				<h5 class="freeboard_title">⊙글 삭제하기</h5>
					<input type="hidden" id="boardCnt" value="7" />
				    ...
				    <table class="table freeboard_tbl">
						<tbody class="tbody">
							<tr>
								...
								<td class="delFreeBoardTd">
								<input type="password" class="password" id="password" name="boardPassword">(게시물 삭제에 사용한 비밀번호를 입력하세요.) </td>
							</tr>
						</tbody>
					</table>
					...
					<div class="bottom_wrapper">
						<div class="board_number_wrapper">
							<button id="QuestionBoardListBtn" class="btn btn-sm">목록</button>

							<span class="btn_span">
								<button id="qboardDelBtn" class="btn btn-sm">삭제</button>
							</span> 
							<span class="btn_span">
